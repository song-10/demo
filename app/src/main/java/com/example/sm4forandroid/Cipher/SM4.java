...
public class SM4 {
    ...
    public static String encryptData_CBC(String plainText, String key) {
        byte[] iv = {(byte) 0x56, (byte) 0x80, (byte) 0x91, (byte) 0x3f, (byte) 0xd0, (byte) 0x69, (byte) 0xf1, (byte) 0x7f, (byte) 0x89, (byte) 0x32, (byte) 0xc3, (byte) 0x92, (byte) 0xa2, (byte) 0xce, (byte) 0xe0, (byte) 0x66};
        String result = "";
        try {
            SM4 sm4 = new SM4();
            ...
            sm4.sm4_setkey_enc(ctx, key_padding(key).getBytes(SM4.CHARSET));
            byte[] encrypted = sm4.sm4_crypt_cbc(ctx, iv, plainText.getBytes(SM4.CHARSET));
    ...
    public static byte[] encryptData_CBC(byte[] plainText, byte[] key) {
        byte[] iv = {(byte) 0x56, (byte) 0x80, (byte) 0x91, (byte) 0x3f, (byte) 0xd0, (byte) 0x69, (byte) 0xf1, (byte) 0x7f, (byte) 0x89, (byte) 0x32, (byte) 0xc3, (byte) 0x92, (byte) 0xa2, (byte) 0xce, (byte) 0xe0, (byte) 0x66};
        byte[] result = null;
        try {
            SM4 sm4 = new SM4();
            ...
            sm4.sm4_setkey_enc(ctx, key_padding(key));
    ...
    public static String decryptData_CBC(String cipherText, String key) {
        ...
        try {
            ...
            sm4.sm4_setkey_dec(ctx, key_padding(key).getBytes(SM4.CHARSET));

            byte[] decrypted = sm4.sm4_crypt_cbc(ctx, iv,decryptBASE64(cipherText));
    ...
    public static byte[] decryptData_CBC(byte[] cipherText, byte[] key) {
        byte[] iv = {(byte) 0x56, (byte) 0x80, (byte) 0x91, (byte) 0x3f, (byte) 0xd0, (byte) 0x69, (byte) 0xf1, (byte) 0x7f, (byte) 0x89, (byte) 0x32, (byte) 0xc3, (byte) 0x92, (byte) 0xa2, (byte) 0xce, (byte) 0xe0, (byte) 0x66};
        byte[] result = null;
        try {
            SM4 sm4 = new SM4();
            ...
            sm4.sm4_setkey_dec(ctx, key_padding(key));
...
//            String ciphertext = "";
//            String decode = "";
//            ciphertext = SM4.encryptData_CBC(plaintext, key);
//            decode = SM4.decryptData_CBC(ciphertext, key);
